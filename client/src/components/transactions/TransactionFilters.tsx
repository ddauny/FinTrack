          ...
          <div className="flex items-center gap-2">
            {hasActiveFilters && (
              <button
                ...
                className="rounded-lg px-2.5 py-1 text-[11px] font-semibold text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-700 dark:text-[#7a7a7a] dark:hover:bg-[#1b1b1b] dark:hover:text-[#d8d8d8]"
              >
                Reset
              </button>
            )}
            ...
            <section className="border-t border-slate-200 pt-5 dark:border-[#1f1f1f]">
              ...
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                {[
                  ...
                  <label key={f.label} className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 dark:border-[#262626] dark:bg-[#151515]">
                    <span className="mb-1 block text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500 dark:text-[#777]">{f.label}</span>
                    <input
                      type="date"
                      value={f.value}
                      onChange={(e) => f.onChange(e.target.value)}
                      className="w-full border-none bg-transparent p-0 text-sm font-medium text-slate-800 outline-none [color-scheme:light] dark:text-[#ddd] dark:[color-scheme:dark]"
                    />
                  </label>
                ))}
              </div>
                ...
                {[
                  ...
                  <label key={f.label} className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 dark:border-[#262626] dark:bg-[#151515]">
                    ...
                    <input
                      ...
                      onChange={(e) => f.onChange(e.target.value)}
                      className="w-full border-none bg-transparent p-0 text-sm font-medium text-slate-800 outline-none placeholder:text-slate-400 dark:text-[#ddd] dark:placeholder:text-[#555]"
                    />
                  </label>
                ))}
              </div>
            ...
            <section className="border-t border-slate-200 pt-5 dark:border-[#1f1f1f]">
              ...
              <div className="mb-3 flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 dark:border-[#262626] dark:bg-[#151515]">
                ...
                <input
                  ...
                  className="w-full border-none bg-transparent p-0 text-sm text-slate-700 outline-none placeholder:text-slate-400 dark:text-[#ddd] dark:placeholder:text-[#555]"
                />
                {catSearch && (
                  <button
                    type="button"
