...
export function DashboardPage() {
  ...
  const lineOption = {
    backgroundColor: resolved === 'dark' ? '#1c1917' : '#ffffff',
    textStyle: {
    ...
    xAxis: {
      ...
      axisLabel: {
        color: resolved === 'dark' ? '#d6d3d1' : '#78716c',
        rotate: 0,
        fontSize: 10,
        interval: 'auto'
      }
    ...
    yAxis: {
      ...
      splitLine: {
        lineStyle: {
          color: resolved === 'dark' ? '#292524' : '#e7e5e4'
        }
      }
    },
    tooltip: {
    ...
    <div className="p-3 space-y-3 lg:h-[calc(100vh-4.25rem)] lg:overflow-y-auto hide-scrollbar flex flex-col">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:items-start lg:h-full lg:grid-rows-[auto_1fr]">
        ...
        <div className="lg:col-span-3 grid grid-cols-1 xl:grid-cols-2 gap-3 lg:h-full min-h-0 xl:grid-rows-[1fr_1fr]">
          {/* Net Worth Over Time */}
          <div className="xl:col-span-2 bg-white dark:bg-stone-800 p-4 rounded-2xl shadow-sm border border-stone-200 dark:border-stone-700 flex flex-col lg:h-full">
          ...
          {/* Asset Allocation */}
          <div className="bg-white dark:bg-stone-800 p-4 rounded-2xl shadow-sm border border-stone-200 dark:border-stone-700 flex flex-col lg:h-full">
        ...
        <div className="lg:col-span-1 bg-white dark:bg-stone-800 p-4 rounded-2xl shadow-sm border border-stone-200 dark:border-stone-700 flex flex-col lg:h-full overflow-hidden">
          ...
          <div className="space-y-3 overflow-y-auto hide-scrollbar flex-1 pr-1">
            {(data.recentTransactions || []).map((txn: any, index: number) => (
              <div key={index} className="group flex items-center justify-between p-1.5 -mx-1.5 rounded-lg hover:bg-stone-50 dark:hover:bg-stone-700/50 transition-colors">
